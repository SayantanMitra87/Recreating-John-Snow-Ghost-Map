...
deaths_list = locations.values.tolist() #or just use  df['a'].tolist()
print (deaths_list[:2])

# Check the length of the list
print(len(locations)) 
# same result with deaths_list or can be done without converting into list as well very simply by print(len(deaths.x_latitude))
